...
func publicStatus(record: String = "null", watch: String = "null", version: String = "v1") -> Data {
  Data("""
  {"data":{"latest_reset":\(record),"active_watch":\(watch),"stats":{"total":0,"last_reset_at":null,"days_since_last":null,"avg_interval_days":null}},"meta":{"api_version":"\(version)","generated_at":"2026-09-07T08:00:00Z"}}
  """.utf8)
}
...
func publicResponse(_ request: URLRequest, status: Int = 200, headers: [String: String] = [:]) -> HTTPURLResponse {
